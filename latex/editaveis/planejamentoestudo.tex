...
\todo[inline, color=pink]{Essa subseção ficou muito simples. Só alguns exemplos de trabalhos relacionados que não foram apresentados: não foi mencionado os modelos Quamoco e principalmente o Qatch, também proposto pelo Siavas, antes desse modelo de segurança. Além do mais, ninguem melhor do que você que leu os 40 artigos selecionados para poder discutir isso.}
...
Para atender à complexidade das questões de pesquisa deste trabalho, optou-se pelo método de estudo de caso incorporado, fundamentado por \citeonline{yin2015estudo}. 
...
\todo[inline, color=pink]{Falta o cap da conclusão do TCC1. Dentre outras questões, a discussão do cronograma apresentado na introdução, bem como o cronograma do tcc 2 deve aparecer. É importante destacar os resultados parciais já obtidos, como o estudo da revisão de literatura.}
