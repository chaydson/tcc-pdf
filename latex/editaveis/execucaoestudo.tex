...
A quantidade de dias foi escolhida depois de um alinhamento com o time de desenvolvimento, que indicou que ciclos quinzenais seriam mais adequados para observar as variações nas métricas de segurança, considerando o ritmo de desenvolvimento, demandas atuais e a possibilidade de analisar e, se possível, iniciar a correção das vulnerabilidades encontradas.

\begin{table}[h]
    \centering
    \caption{Períodos Analisados}
    \begin{tabular}{|p{2cm}|p{5cm}|}
        \hline
        \textbf{Grupo} & \textbf{Intervalo} \\
        \hline
        1 & 17/08/25 até 30/08/25 \\
        \hline
        2 & 31/08/25 até 13/09/25 \\
        \hline
        3 & 14/09/25 até 27/09/25 \\
        \hline
        4 & 28/09/25 até 11/10/25 \\
        \hline
        5 & 12/10/25 até 25/10/25 \\
        \hline
        6 & 26/10/25 até 08/11/25 \\
        \hline
        7 & 09/11/25 até 22/11/25 \\
        \hline
    \end{tabular} \\[0.5em]
    \label{tab:periodos-analisados}
    \small Fonte: Autor
\end{table}
...
Infelizmente, devido a limitações de tempo e recursos, não foi possível aplicar o questionário planejado para coletar dados qualitativos sobre a opinião dos desenvolvedores envolvidos no projeto. A aplicação do questionário ou de outro método de coleta de dados qualitativos exigiria um planejamento detalhado, o que não pôde ser realizado dentro do cronograma estabelecido para este estudo de caso. Ademais, o time de desenvolvimento não recebia os dados já tratados por parte do time de segurança, de forma a orientar a tomada de decisão com mais clareza, o que demandaria um grande trabalho por parte da equipe que já se encontrava em um ciclo de entrega intenso. Portanto, a análise se concentrou exclusivamente nos dados quantitativos coletados através das ferramentas automatizadas descritas anteriormente.
