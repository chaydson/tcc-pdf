...
\todo[inline, color=pink]{É importante explicar que fizemos esse recorte de duas semanas para tentar contemplar o tamanho do sprint realizado pelo time. Além disso monte uma tabela listando as datas de todos os períodos. }
...
\todo[inline, color=pink]{Importante explicar que o time de desenvolvimento não recebia esses dados já tratados de forma a orientar a tomada de decisão com mais clareza. }